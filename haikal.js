...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC © banghw`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/channel/UCnQANmWo4iOyC6q6psb5eVg`}}}, { quoted: m })} 
//=================================================//
try {
...
"message": `${teks}`,
"orderTitle": `${teks}`,
"sellerJid": "6285217773280@s.whatsapp.net",
...
{ callButton: { displayText: `OWNER`, phoneNumber: `6285217773280`}},
...
urlButton: {
displayText: `GITHUB`,
url: 'https://youtube.com/channel/UCnQANmWo4iOyC6q6psb5eVg'
}
},
{
quickReplyButton: {
...
reply(mess.success)
} catch { reply('𝐆𝐚𝐠𝐚𝐥 𝐌𝐞𝐧𝐠𝐠𝐚𝐧𝐭𝐢 𝐅𝐨𝐭𝐨 𝐅𝐫𝐨𝐟𝐢𝐥') }
}
break
